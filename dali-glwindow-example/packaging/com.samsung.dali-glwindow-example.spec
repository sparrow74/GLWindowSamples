...
Name:       com.samsung.dali-glwindow-example
Summary:    DALi Example
Version:    1.0.0
Release:    1
Group:      System/Libraries
License:    Apache-2.0
URL:        https://github.com/dalihub/dali-glwindow-example
...
%define dali_app_ro_dir       %TZ_SYS_RO_APP/com.samsung.dali-glwindow-example/
...
%manifest com.samsung.dali-glwindow-example.manifest-smack
%else
%manifest com.samsung.dali-glwindow-example.manifest
%endif
%defattr(-,root,root,-)
%{dali_app_exe_dir}/dali-glwindow-example
